...
import com.symbol.kumkangpop.databinding.RowReport2Binding;
import com.symbol.kumkangpop.model.object.Report;

import java.text.DecimalFormat;
import java.util.ArrayList;

public class AdapterReport2 extends RecyclerView.Adapter<AdapterReport2.ViewHolder> {
    ...
    public AdapterReport2(ArrayList<Report> items, Context context, ActivityResultLauncher<Intent> resultLauncher) {
   ...
   /* public ProgressFloorReturnViewAdapter(Context context, LinearLayout layoutTop, String contractNo, String fromDate) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        ...
        RowReport2Binding binding = DataBindingUtil.inflate(inflater, R.layout.row_report2, viewGroup, false);
        return new AdapterReport2.ViewHolder(binding);
    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        RowReport2Binding binding;
        //View row;

        public ViewHolder(RowReport2Binding binding) {
        ...
        public void setItem(Report item, int position) {
            ...
            binding.tvQty1.setText(numFormatter.format(item.InQty));
            binding.tvQty2.setText(numFormatter.format(item.ScrapQty));
            binding.tvQty3.setText(numFormatter.format(item.SettlementQty));

            binding.tvWeight1.setText(numFormatter.format(item.InWeight));
            binding.tvWeight2.setText(numFormatter.format(item.ScrapWeight));
            binding.tvWeight3.setText(numFormatter.format(item.SettlementWeight));

            binding.tvVolumn1.setText(numFormatter.format(item.InVolumn));
            binding.tvVolumn2.setText(numFormatter.format(item.ScrapVolumn));
            binding.tvVolumn3.setText(numFormatter.format(item.SettlementVolumn));
            ...
            //binding.layoutMain.setBackgroundResource(R.drawable.borderline_bottom);
