...
import com.symbol.kumkangpop.databinding.Row5200Binding;
import com.symbol.kumkangpop.model.object.Customer;
import com.symbol.kumkangpop.model.object.Customer;
import com.symbol.kumkangpop.view.CommonMethod;
import com.symbol.kumkangpop.view.activity.menu5.Activity5200;
import com.symbol.kumkangpop.viewmodel.BarcodeConvertPrintViewModel;

import java.text.DecimalFormat;
import java.util.ArrayList;

public class Adapter5200 extends RecyclerView.Adapter<Adapter5200.ViewHolder>  implements Filterable{
    ...
    public Adapter5200(ArrayList<Customer> items, Context context, ActivityResultLauncher<Intent> resultLauncher, BarcodeConvertPrintViewModel barcodeConvertPrintViewModel) {
   ...
   /* public ProgressFloorReturnViewAdapter(Context context, LinearLayout layoutTop, String contractNo, String fromDate) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        ...
        Row5200Binding binding = DataBindingUtil.inflate(inflater, R.layout.row5200, viewGroup, false);
        return new Adapter5200.ViewHolder(binding);
    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        Row5200Binding binding;
        //View row;

        public ViewHolder(Row5200Binding binding) {
        ...
        public void setItem(Customer item, int position) {
            ...
            binding.getRoot().setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ((Activity5200)context).ScanStockOutTag((int)item.LocationNo);
                }
            });
