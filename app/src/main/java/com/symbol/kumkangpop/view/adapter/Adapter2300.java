...
import com.symbol.kumkangpop.databinding.Row2300Binding;
...
public class Adapter2300 extends RecyclerView.Adapter<Adapter2300.ViewHolder> implements Filterable {
    ...
    public Adapter2300(ArrayList<ScanListViewItem2> items, Context context, ActivityResultLauncher<Intent> resultLauncher, BarcodeConvertPrintViewModel barcodeConvertPrintViewModel) {
   ...
   /* public ProgressFloorReturnViewAdapter(Context context, LinearLayout layoutTop, String contractNo, String fromDate) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        ...
        Row2300Binding binding = DataBindingUtil.inflate(inflater, R.layout.row2300, viewGroup, false);
        return new Adapter2300.ViewHolder(binding);
    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        Row2300Binding binding;
        //View row;

        public ViewHolder(Row2300Binding binding) {
                    ...
                    materialAlertDialogBuilder.setItems(sequences, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            if (which == 0) {//작업목록 제외
                                ...
                                String title = "포장제외";
                                String message = "번들항목에서 포장을 제외 하시겠습니까?\n" + item.PackingNo;
                                String okString = "확인";
                                String noString = "취소";

                                if (Users.Language != 0) {
                                    title = "Exclude Packing";
                                    message = "Are you sure you want to exclude packaging from the bundle item?\n" + item.PackingNo;
                                    okString = "Confirm";
                                    noString = "Cancel";
                                }
                                ...
                                new MaterialAlertDialogBuilder(context)
                                        ...
                                        .setPositiveButton(okString, new DialogInterface.OnClickListener() {
                                            @Override
                                            public void onClick(DialogInterface dialog, int which) {
                                                ((Activity2300) (context)).RemovePacking(item.PackingNo);
                                            }
                                        })
    ...
    /*private void startCamera(String packingNo) {
        try {
            ...
            ((Activity2300) (context)).tempPackingNo = packingNo;
