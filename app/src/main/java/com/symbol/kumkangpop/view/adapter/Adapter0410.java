...
import com.symbol.kumkangpop.databinding.Row0410Binding;
import com.symbol.kumkangpop.model.object.Packing;

import java.text.DecimalFormat;
import java.util.ArrayList;

public class Adapter0410 extends RecyclerView.Adapter<Adapter0410.ViewHolder> {
    ...
    public Adapter0410(ArrayList<Packing> items, Context context, ActivityResultLauncher<Intent> resultLauncher) {
   ...
   /* public ProgressFloorReturnViewAdapter(Context context, LinearLayout layoutTop, String contractNo, String fromDate) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        ...
        Row0410Binding binding = DataBindingUtil.inflate(inflater, R.layout.row0410, viewGroup, false);
        return new Adapter0410.ViewHolder(binding);
    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        Row0410Binding binding;
        //View row;

        public ViewHolder(Row0410Binding binding) {
        ...
        public void setItem(Packing item, int position) {
            ...
            String qty = numFormatter.format(item.StockOutOrderQty)+"/"+numFormatter.format(item.StockOutQty);
