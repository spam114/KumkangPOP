...
import com.symbol.kumkangpop.databinding.Row0400Binding;
...
public class Adapter0400 extends RecyclerView.Adapter<Adapter0400.ViewHolder> {
    ...
    public Adapter0400(ArrayList<Packing> items, Context context, ActivityResultLauncher<Intent> resultLauncher, BarcodeConvertPrintViewModel barcodeConvertPrintViewModel) {
   ...
   /* public ProgressFloorReturnViewAdapter(Context context, LinearLayout layoutTop, String contractNo, String fromDate) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        ...
        Row0400Binding binding = DataBindingUtil.inflate(inflater, R.layout.row0400, viewGroup, false);
        return new Adapter0400.ViewHolder(binding);
    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        Row0400Binding binding;
        //View row;

        public ViewHolder(Row0400Binding binding) {
