...
import com.symbol.kumkangpop.databinding.Row5100Binding;
...
public class Adapter5100 extends RecyclerView.Adapter<Adapter5100.ViewHolder>  implements Filterable{
    ...
    public Adapter5100(ArrayList<Container> items, Context context, ActivityResultLauncher<Intent> resultLauncher, BarcodeConvertPrintViewModel barcodeConvertPrintViewModel) {
   ...
   /* public ProgressFloorReturnViewAdapter(Context context, LinearLayout layoutTop, String contractNo, String fromDate) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        ...
        Row5100Binding binding = DataBindingUtil.inflate(inflater, R.layout.row5100, viewGroup, false);
        return new Adapter5100.ViewHolder(binding);
    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        Row5100Binding binding;
        //View row;

        public ViewHolder(Row5100Binding binding) {
