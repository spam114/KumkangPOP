...
import com.symbol.kumkangpop.view.adapter.Adapter5340;
...
public class Dialog5340 extends DialogFragment implements BaseActivityInterface {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.dialog5340, container, false);
    ...
    private void init() {
        ...
        observerViewModel();
        setListener();
        adapter = new Adapter5340(new ArrayList<>(), getContext(), this);
    ...
    private void setLanguage() {
        if (Users.Language != 0) {
            textView1.setText("CarryCom");
            textView3.setText("CompName");
        }
    }
    ...
    private void GetMainData() {
        ...
        sc.CustomerClass = 3;
        sc.CustomerCode = "";
        commonViewModel.Get("GetCustomersDataClass", sc);
    }
