...
import com.symbol.kumkangpop.databinding.Row3000Binding;
...
public class Adapter3000 extends RecyclerView.Adapter<Adapter3000.ViewHolder> implements Filterable {
    ...
    public Adapter3000(ArrayList<SalesOrder> items, Context context, ActivityResultLauncher<Intent> resultLauncher, CommonViewModel commonViewModel, BarcodeConvertPrintViewModel barcodeConvertPrintViewModel) {
   ...
   /* public ProgressFloorReturnViewAdapter(Context context, LinearLayout layoutTop, String contractNo, String fromDate) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        ...
        Row3000Binding binding = DataBindingUtil.inflate(inflater, R.layout.row3000, viewGroup, false);
        return new Adapter3000.ViewHolder(binding);
    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        Row3000Binding binding;
        //View row;

        public ViewHolder(Row3000Binding binding) {
