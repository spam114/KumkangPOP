...
import com.symbol.kumkangpop.view.adapter.Adapter5350;
...
public class Dialog5350 extends DialogFragment implements BaseActivityInterface {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.dialog5350, container, false);
    ...
    private void init() {
        ...
        observerViewModel();
        setListener();
        adapter = new Adapter5350(new ArrayList<>(), getContext(), this);
    ...
    private void GetMainData() {
        ...
        sc.AreaCode = "";
        commonViewModel.Get("GetRegionData", sc);
    }
    ...
    public void observerViewModel() {
        ...
        commonViewModel.data.observe(this, data -> {
            if (data != null) {
                ...
                adapter.updateAdapter(data.AreaList);
