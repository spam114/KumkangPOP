...
import com.symbol.kumkangpop.databinding.Row3310Binding;
import com.symbol.kumkangpop.model.object.ScanListViewItem2;
import com.symbol.kumkangpop.model.object.Users;
import com.symbol.kumkangpop.view.activity.menu3.Activity3310;
import com.symbol.kumkangpop.viewmodel.BarcodeConvertPrintViewModel;

import java.text.DecimalFormat;
import java.util.ArrayList;

public class Adapter3310 extends RecyclerView.Adapter<Adapter3310.ViewHolder> implements Filterable {
    ...
    public Adapter3310(ArrayList<ScanListViewItem2> items, Context context, ActivityResultLauncher<Intent> resultLauncher, BarcodeConvertPrintViewModel barcodeConvertPrintViewModel) {
   ...
   /* public ProgressFloorReturnViewAdapter(Context context, LinearLayout layoutTop, String contractNo, String fromDate) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        ...
        Row3310Binding binding = DataBindingUtil.inflate(inflater, R.layout.row3310, viewGroup, false);
        return new Adapter3310.ViewHolder(binding);
    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        Row3310Binding binding;
        //View row;

        public ViewHolder(Row3310Binding binding) {
                    ...
                    materialAlertDialogBuilder.setItems(sequences, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            if (which == 0) {//작업목록 제외
                                ...
                                String title = "이송제외";
                                String message = "이송항목에서 포장을 제외 하시겠습니까?\n" + item.PackingNo;
                                String okString = "확인";
                                String noString = "취소";

                                if (Users.Language != 0) {
                                    title = "Exclude Transfer";
                                    message = "Are you sure you want to exclude packaging from the transfer item?\n" + item.PackingNo;
                                    okString = "Confirm";
                                    noString = "Cancel";
                                }
                                ...
                                new MaterialAlertDialogBuilder(context)
                                        ...
                                        .setPositiveButton(okString, new DialogInterface.OnClickListener() {
                                            @Override
                                            public void onClick(DialogInterface dialog, int which) {
                                                ((Activity3310) (context)).RemoveStockOut(item.PackingNo);
                                            }
                                        })
