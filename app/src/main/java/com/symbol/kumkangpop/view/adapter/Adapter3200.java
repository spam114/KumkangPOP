...
import com.symbol.kumkangpop.databinding.Row3200Binding;
import com.symbol.kumkangpop.model.object.ScanListViewItem2;
import com.symbol.kumkangpop.model.object.Users;
import com.symbol.kumkangpop.view.activity.menu3.Activity3200;
import com.symbol.kumkangpop.viewmodel.BarcodeConvertPrintViewModel;

import java.text.DecimalFormat;
import java.util.ArrayList;

public class Adapter3200 extends RecyclerView.Adapter<Adapter3200.ViewHolder> implements Filterable {
    ...
    public Adapter3200(ArrayList<ScanListViewItem2> items, Context context, ActivityResultLauncher<Intent> resultLauncher, BarcodeConvertPrintViewModel barcodeConvertPrintViewModel) {
   ...
   /* public ProgressFloorReturnViewAdapter(Context context, LinearLayout layoutTop, String contractNo, String fromDate) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        ...
        Row3200Binding binding = DataBindingUtil.inflate(inflater, R.layout.row3200, viewGroup, false);
        return new Adapter3200.ViewHolder(binding);
    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        Row3200Binding binding;
        //View row;

        public ViewHolder(Row3200Binding binding) {
                            ...
                            if (which == 0) {//작업목록 제외
                                ...
                                new MaterialAlertDialogBuilder(context)
                                        ...
                                        .setPositiveButton(okString, new DialogInterface.OnClickListener() {
                                            @Override
                                            public void onClick(DialogInterface dialog, int which) {
                                                ((Activity3200) (context)).Scanning(item.PackingNo);
                                            }
                                        })
                                ...
                                new MaterialAlertDialogBuilder(context)
                                        ...
                                        .setPositiveButton(okString, new DialogInterface.OnClickListener() {
                                            @Override
                                            public void onClick(DialogInterface dialog, int which) {
                                                ((Activity3200) (context)).ScanStockOut(item.PackingNo);
                                            }
                                        })
                                        .setNegativeButton(noString, new DialogInterface.OnClickListener() {
                                            @Override
    ...
    /*private void startCamera(String packingNo) {
        try {
            ...
            ((Activity3200) (context)).tempPackingNo = packingNo;
