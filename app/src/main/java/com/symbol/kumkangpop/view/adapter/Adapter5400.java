...
import com.symbol.kumkangpop.databinding.Row5400Binding;
...
public class Adapter5400 extends RecyclerView.Adapter<Adapter5400.ViewHolder>  implements Filterable{
    ...
    public Adapter5400(ArrayList<StockOutDetail> items, Context context, ActivityResultLauncher<Intent> resultLauncher, BarcodeConvertPrintViewModel barcodeConvertPrintViewModel) {
   ...
   /* public ProgressFloorReturnViewAdapter(Context context, LinearLayout layoutTop, String contractNo, String fromDate) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        ...
        Row5400Binding binding = DataBindingUtil.inflate(inflater, R.layout.row5400, viewGroup, false);
        return new Adapter5400.ViewHolder(binding);
    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        Row5400Binding binding;
        //View row;

        public ViewHolder(Row5400Binding binding) {
