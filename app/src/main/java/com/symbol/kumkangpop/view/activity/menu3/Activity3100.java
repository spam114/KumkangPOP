...
public class Activity3100 extends BaseActivity {
    ...
    private void init() {
        ...
        setResultLauncher();
        adapter = new Adapter3100(new ArrayList<>(), this, resultLauncher, barcodeConvertPrintViewModel);
        observerViewModel();
    ...
    private void setView() {
        if (Users.Language == 1) {
            ...
            binding.textView41.setText("Car No");
        ...
        new MaterialAlertDialogBuilder(this)
                ...
                .setPositiveButton(strPoButton, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        sc.GLocationNo = Users.LocationNo;
    ...
    private void setListener() {
        ...
        binding.btnRePrint.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getBaseContext(), Activity3110.class);
                activityResultLauncher.launch(intent);
            }
        });
    }
