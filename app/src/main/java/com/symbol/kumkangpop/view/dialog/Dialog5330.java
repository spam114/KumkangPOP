...
import com.symbol.kumkangpop.view.adapter.Adapter5330;
...
public class Dialog5330 extends DialogFragment implements BaseActivityInterface {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.dialog5330, container, false);
    ...
    private void init() {
        ...
        observerViewModel();
        setListener();
        adapter = new Adapter5330(new ArrayList<>(), getContext(), this);
    ...
    private void GetMainData() {
        ...
        commonViewModel.Get("GetDeptDataBusiness", sc);
    }
    ...
    public void observerViewModel() {
        ...
        commonViewModel.data.observe(this, data -> {
            if (data != null) {
                ...
                adapter.updateAdapter(data.DeptList);
