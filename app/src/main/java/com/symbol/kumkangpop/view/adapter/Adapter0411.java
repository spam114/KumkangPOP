...
import com.symbol.kumkangpop.databinding.Row0411Binding;
import com.symbol.kumkangpop.model.object.Packing;

import java.text.DecimalFormat;
import java.util.ArrayList;

public class Adapter0411 extends RecyclerView.Adapter<Adapter0411.ViewHolder>  implements Filterable{
    ...
    public Adapter0411(ArrayList<Packing> items, Context context, ActivityResultLauncher<Intent> resultLauncher) {
   ...
   /* public ProgressFloorReturnViewAdapter(Context context, LinearLayout layoutTop, String contractNo, String fromDate) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        ...
        Row0411Binding binding = DataBindingUtil.inflate(inflater, R.layout.row0411, viewGroup, false);
        return new Adapter0411.ViewHolder(binding);
    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        Row0411Binding binding;
        //View row;

        public ViewHolder(Row0411Binding binding) {
