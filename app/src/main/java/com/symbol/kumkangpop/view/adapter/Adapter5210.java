...
import com.symbol.kumkangpop.databinding.Row5210Binding;
...
public class Adapter5210 extends RecyclerView.Adapter<Adapter5210.ViewHolder>  implements Filterable{
    ...
    public Adapter5210(ArrayList<StockOut> items, Context context, ActivityResultLauncher<Intent> resultLauncher, BarcodeConvertPrintViewModel barcodeConvertPrintViewModel) {
   ...
   /* public ProgressFloorReturnViewAdapter(Context context, LinearLayout layoutTop, String contractNo, String fromDate) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        ...
        Row5210Binding binding = DataBindingUtil.inflate(inflater, R.layout.row5210, viewGroup, false);
        return new Adapter5210.ViewHolder(binding);
    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        Row5210Binding binding;
        //View row;

        public ViewHolder(Row5210Binding binding) {
