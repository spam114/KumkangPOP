...
import com.symbol.kumkangpop.model.CommonService;
...
public class CommonViewModel extends ViewModel {
    ...
    public MutableLiveData<SData> str = new MutableLiveData<>();//todo
    public MutableLiveData<SData> str2 = new MutableLiveData<>();//todo
    public MutableLiveData<SData> str3 = new MutableLiveData<>();//todo
    /*public void GetTest() {
