...
import com.symbol.kumkangpop.model.RecyclerViewService;
...
public class RecyclerViewModel extends ViewModel {
    ...
    public RecyclerViewService service = RecyclerViewService.getInstance();
    // Single 객체를 가로채기 위함
    private CompositeDisposable disposable = new CompositeDisposable();
    public MutableLiveData<List<Object>> dataList = new MutableLiveData<>();//데이터 리스트
    public MutableLiveData<Object> list = new MutableLiveData<>();//Live Data 갱신을 위해 데이터목록을 따로 관리
